...
<nav>
	...
	<div class="menu-item navi-homelink">
		<h3 class="menu-title menu-title-homelink">
			<a href="/markpost" class="ft-subtitle" onclick={resetPanel}>
				<HomeIcon />
			</a>
		</h3>
	</div>
	...
	<div class="menu-item navi-search">
		<h3 class="menu-title menu-title-search">
			<a href="/markpost/search" class="ft-subtitle" onclick={resetPanel}>
				<SearchIcon />
			</a>
		</h3>
	</div>
	...
	<div class="menu-item navi-settings">
		<h3 class="menu-title menu-title-settings">
			<a href="/markpost/settings" class="ft-subtitle" onclick={resetPanel}>
				<SettingsIcon />
			</a>
		</h3>
	</div>
