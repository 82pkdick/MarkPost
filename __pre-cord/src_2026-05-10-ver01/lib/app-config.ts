...
const AppConfig = {
  ...
  JsonDataHostUrl: {
    production:  "http://192.168.3.9/MarkoutSuite",
  ...
  // MarkDownloader コマンドの場所
  MarkDownloaderPath: "mark-downloader",
  // MarkDownloader の作業DIR
  MarkDownloaderMedialist: "mark-downloader/work/medialist.json",
};
