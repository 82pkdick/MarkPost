<script lang="ts">
  ...
  import { getParams, deleteUrlParam } from "$lib/utils/locationUtils";
  import { 
    getCurrentPost, 
    closePostPanel,
...
<section id="postPanel" class="post-panel base-bg">
  <PostPanel contentsDir={data.pathSettings.MdFilePath} searchq={qword} />
</section>
