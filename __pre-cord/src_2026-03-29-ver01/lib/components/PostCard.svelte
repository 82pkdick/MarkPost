<script lang="ts">
  ...
  import { setPostPanelState, setPreviewPanelState, setEditorMode, setCurrentPost, getThumbnailPath } from "$lib/index.svelte";
	import type { Snippet } from "svelte";

  let { post, children }:{ post: LoadedPostData | SearchResultData; children: Snippet } = $props();
