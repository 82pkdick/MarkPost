  ...
  <div id="editPostData" class="edit-post-data base-bg">
    ...
    <form onsubmit={(e) => handleSubmit(e)} class="form-panel form-post-update">
      ...
      <section class="data-info-wrap">
        <div class="unify">
          <div class="wrapper input post-id hidden-input">
          ...
          <div class="wrapper input post-date hidden-input">
        ...
        <div class="wrapper input post-url hidden-input">
        ...
        <div class="unify">
          <div class="wrapper input post-type hidden-input">
          ...
          <div class="wrapper input post-videourl hidden-input">
          ...
          <div class="wrapper input post-moviearchive hidden-input">
        ...
        <div class="unify">
          <div class="wrapper input post-filedir hidden-input">
          ...
          <div class="wrapper input post-filepath hidden-input">
